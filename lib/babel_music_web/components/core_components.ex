defmodule BabelMusicWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BabelMusicWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BabelMusicWeb.Gettext, "errors", msg, opts)
    end
  end
